...
<div class="pagetitle">
    <h1>Dashboard. Hell0 {{Auth()->user()->role}}</h1>
    <nav>
        <ol class="breadcrumb">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('template/assets/img/product-1.jpg') }}"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('template/assets/img/product-2.jpg') }}"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('template/assets/img/product-3.jpg') }}"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('template/assets/img/product-4.jpg') }}"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('template/assets/img/product-5.jpg') }}"
                                                    alt=""></a></th>
